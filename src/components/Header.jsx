  ...
  return (
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between">
        ...
        <img src={Logox} className="w-16 object-cover" alt="logo" />
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="relative">
            ...
            {isMenu && (
              ...
              >
                {user && user.email === "ritik210798@gmail.com" && (
                  <Link to={"/createItem"}>
                    <p
...
<p className='text-headingColor text-xl font-bold'> foodx
</p>
...
<MdShoppingCart className="text-textColor text-2x1 ml-8 cursor-pointer"/>
<div className='absolute -top-2 -right-2 w-5 h-5 rounded-full bg-cartBg flex items-center justify-center'> 
<p className='text-xs text-white font-semibold' >2
</p>
</div>
</div>
